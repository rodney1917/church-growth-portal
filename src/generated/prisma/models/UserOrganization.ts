...
export type UserOrganizationMinAggregateOutputType = {
  ...
  access: $Enums.OrganizationAccess | null
}
...
export type UserOrganizationGroupByOutputType = {
  ...
  access: $Enums.OrganizationAccess
  _count: UserOrganizationCountAggregateOutputType | null
  _min: UserOrganizationMinAggregateOutputType | null
  _max: UserOrganizationMaxAggregateOutputType | null
}

export type GetUserOrganizationGroupByPayload<T extends UserOrganizationGroupByArgs> = Prisma.PrismaPromise<
  Array<
...
export type UserOrganizationWhereInput = {
  ...
  access?: Prisma.EnumOrganizationAccessFilter<"UserOrganization"> | $Enums.OrganizationAccess
...
export type UserOrganizationScalarWhereWithAggregatesInput = {
  ...
  access?: Prisma.EnumOrganizationAccessWithAggregatesFilter<"UserOrganization"> | $Enums.OrganizationAccess
}

export type UserOrganizationCreateInput = {
  access?: $Enums.OrganizationAccess
  user: Prisma.UserCreateNestedOneWithoutOrganizationAccessInput
...
export type UserOrganizationUpdateInput = {
  access?: Prisma.EnumOrganizationAccessFieldUpdateOperationsInput | $Enums.OrganizationAccess
  user?: Prisma.UserUpdateOneRequiredWithoutOrganizationAccessNestedInput
...
export type EnumOrganizationAccessFieldUpdateOperationsInput = {
  set?: $Enums.OrganizationAccess
}
...
export type UserOrganizationOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"userId" | "organizationId" | "access", ExtArgs["result"]["userOrganization"]>
...
export interface UserOrganizationDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * })
   * 
   * // Update zero or more UserOrganizations and only return the `userId`
   * const userOrganizationWithUserIdOnly = await prisma.userOrganization.updateManyAndReturn({
   *   select: { userId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface UserOrganizationFieldRefs {
  ...
  readonly access: Prisma.FieldRef<"UserOrganization", 'OrganizationAccess'>
}
